...
final class ElasticsearchPrefixesSuggester extends AbstractElasticsearchQuerySuggester
{
     ...
     * incumbent gets out of its n-gram index.
     *
     ...
     * artificially slow next to the incumbent's `operator: and`. "100%" is the
     * same instruction as `operator: and` here; it is spelled as a percentage
     * because at the call site it reads as "every token the user typed", which
