...
final class ElasticsearchSuggester extends AbstractElasticsearchQuerySuggester
{
     ...
     *
     * The finished words go to search_text.folded and only the half-typed token
     * to the n-grammed parent. Running the finished words against the n-grams
     * too - which this used to do - quietly widened recall: in "gent kort" the
     * complete word "gent" also matched Gentbrugge and Gentse, because both
     * contain an indexed n-gram "gent". The gate is the one place in this query
     * where nothing downstream can undo a mistake, so it is worth being exact.
     *
