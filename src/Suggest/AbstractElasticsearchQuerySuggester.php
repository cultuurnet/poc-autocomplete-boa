 ...
 *
 *   gateClause()    which field and which query type carries the recall gate
...
abstract class AbstractElasticsearchQuerySuggester extends AbstractElasticsearchSuggester
{
     ...
     */
    abstract protected function gateClause(string $text, bool $fuzzyFallback): array;
